...
public class FileDownloadController {
    ...
    public void cvplFileDownload(Map<String, Object> commandMap,@RequestParam Map<String, Object> params, HttpServletRequest request, HttpServletResponse response) throws Exception {
	...
	if (isAuthenticated) {*/
System.out.println("filedown1:"+atchFileId);
	    FileVO fileVO = new FileVO();
	    fileVO.setAtchFileId(atchFileId);
	    fileVO.setFileSn(fileSn);
	    FileVO fvo = fileService.selectFileInf(fileVO);

	    File uFile = new File(fvo.getFileStreCours(), fvo.getStrefileName());
		...
		//response.setHeader("Content-Disposition", "attachment; filename=\"" + URLEncoder.encode(fvo.getOrignlfileName(), "utf-8") + "\"");
