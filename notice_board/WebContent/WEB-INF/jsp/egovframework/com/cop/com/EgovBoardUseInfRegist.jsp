...
<script type="text/javascript">
	...
	function fn_egov_inqire_bbsInf(){
		...
		if (retVal != null) {
			...
			document.boardUseInf.bbsName.value = tmp[1];
		}
	}
...
<div id="border" style="width:730px">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register">
	  <tr>
	    <th width="30%" height="23" class="required_text" nowrap ><spring:message code="cop.bbsName" />
	    ...
	    <td width="70%" nowrap colspan="3">
	      ...
	      <input name="bbsName" type="text" size="40" value=""  maxlength="40" title="게시판명" readonly />
